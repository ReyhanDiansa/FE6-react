                ...
                <div class="autoplay">
                  <Slider ref={(c) => (this.slider = c)} {...settings}>
                    <div class="img-wrapper">
                      <img
                        src={require("./assets/images/adi-car1.jpeg")}
                        alt=""
                      />
                    </div>
                    <div class="img-wrapper">
                      <img
                        src={require("./assets/images/adi-car2.jpeg")}
                        alt=""
                      />
                    </div>
                    <div class="img-wrapper">
                      <img
                        src={require("./assets/images/adi-car3.jpeg")}
                        alt=""
                      />
                    </div>
                    <div class="img-wrapper">
                      <img
                        src={require("./assets/images/adi-car4.jpeg")}
                        alt=""
                      />
                    </div>
                  </Slider>
