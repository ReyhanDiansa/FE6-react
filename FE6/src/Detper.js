                ...
                <div class="autoplay">
                  <Slider ref={(c) => (this.slider = c)} {...settings}>
                    <div class="img-wrapper">
                      <img
                        src={require(`./assets/images/${id2.imagecar1}`)}
                        alt=""
                      />
                    </div>
                    <div class="img-wrapper">
                      <img
                        src={require(`./assets/images/${id2.imagecar2}`)}
                        alt=""
                      />
                    </div>
                    <div class="img-wrapper">
                      <img
                        src={require(`./assets/images/${id2.imagecar3}`)}
                        alt=""
                      />
                    </div>
                    <div class="img-wrapper">
                      <img
                        src={require(`./assets/images/${id2.imagecar4}`)}
                        alt=""
                      />
                    </div>
                  </Slider>
